...
export SPI_MODE='0'
export SPI_BACKEND='hardware'   # hardware | software
export SOFT_SPI_SCK_PIN='11'
export SOFT_SPI_MOSI_PIN='10'
export SOFT_SPI_BIT_DELAY_US='1'
export SOFT_SPI_CS_GAP_US='10'
export PIN_RST='17'
export PIN_DC='25'
export PIN_CS='8'
export PIN_BUSY='24'
